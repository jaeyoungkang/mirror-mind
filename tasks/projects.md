...
- 하위 업무:
  ...
  - [>] 나의 학기 사용설명서 — MBTI 기반 5챕터 시스템 `재영`
    - 배경: 기존 "학업 운세" 단일 콘텐츠의 흥미도 부족 → 5가지 포맷으로 확장
    - 기획서: `projects/moonlight/fortune-feature-spec.md` (기존, 참고용)
    - 구현 프롬프트: `projects/moonlight/manual-implementation-prompt.md`
    ...
    - 핵심: 참여=응원+1(하루 1챕터), 공유유입=공유자 응원+1
    ...
    - [ ] 구현 에이전트에 위임 (Phase 1~4)
    - [!] 기존 프로파일 자동 생성 테스트 — 사용설명서 구현에 흡수
